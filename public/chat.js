...
socket.on("someOneTyping", (data)=>{
     document.getElementById("typing").innerHTML ="<b>"+ data.username+"<b>"+"    <i>is Typing.....</i>";
})
...
function loadUsers(){
    socket.emit("loadUsers", document.getElementById("roomid").value, (userList)=>{
        console.clear();
